...
**Note**: To install services [insight-api](https://github.com/vpubchain/vircle-insight-api) and [insight-ui](https://github.com/vpubchain/vircle-insight-ui) you'll need to clone the repositories locally.
